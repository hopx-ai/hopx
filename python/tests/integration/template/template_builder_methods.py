...
from tests.conftest import _register_template, _register_sandbox, _register_async_sandbox
...
class TestTemplateBuilderMethods:
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(300)
    async def test_from_ubuntu_image_integration(self, api_key, template_name, cleanup_template):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(300)
    async def test_template_with_env_vars_integration(self, api_key, template_name, cleanup_template):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(300)
    async def test_template_builder_chaining_integration(self, api_key, template_name, cleanup_template):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(300)
    async def test_template_skip_cache_integration(self, api_key, template_name, cleanup_template):
        """
