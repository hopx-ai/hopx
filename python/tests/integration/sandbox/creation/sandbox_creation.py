...
class TestSandboxCreation:
    ...
    def test_create_from_template_name(self, api_key, cleanup_sandbox):
    ...
    def test_create_with_env_vars(self, api_key, cleanup_sandbox):
    ...
    def test_create_with_timeout(self, api_key, cleanup_sandbox):
    ...
    def test_create_without_internet(self, api_key, cleanup_sandbox):
